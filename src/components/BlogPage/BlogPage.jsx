...
const BlogPage = () => {
    ...
    return(
        <>
            ...
            <MetaData 
                title={"Blogs - Ananta Aspire Zirakpur"}
                description={"Experience unmatched luxury and convenience with the premium blogs at Ananta Aspire."}
                    ...
                    <Row>
                        <Col lg={8}>
                            ...
                            
                            {
                                ...
                                : 
                                    <p className="paragraph">No Blog Found.</p>
                            }
